# Thesis Report: Figures to Attach and Full Code

## Figures to Attach

Place these images in a `figures/` folder in your thesis directory, then reference them in the LaTeX file.

| Figure | File Name | Description |
|--------|-----------|-------------|
| Figure 1 | `gradcam_sample_1.png` | Sample 1: True=0 (Non-Diabetic), Pred=0 (0.28) – Correct |
| Figure 2 | `gradcam_sample_2.png` | Sample 2: True=1 (Diabetic), Pred=0 (0.45) – Incorrect |
| Figure 3 | `gradcam_sample_3.png` | Sample 3: True=0 (Non-Diabetic), Pred=0 (0.06) – Correct |
| Figure 4 | `gradcam_sample_4.png` | Sample 4: True=0 (Non-Diabetic), Pred=0 (0.07) – Correct |
| Figure 5 | `gradcam_sample_5.png` | Sample 5: True=0 (Non-Diabetic), Pred=0 (0.03) – Correct |
| Figure 6 | `gradcam_sample_6.png` | Sample 6: True=0 (Non-Diabetic), Pred=0 (0.14) – Correct |
| Figure 7 | `gradcam_sample_7.png` | Sample 7: True=0 (Non-Diabetic), Pred=0 (0.04) – Correct |
| Figure 8 | `gradcam_sample_8.png` | Sample 8: True=0 (Non-Diabetic), Pred=0 (0.03) – Correct |

**Source:** Copy from `FDI/` folder after running `gradcam_explainability.py`.

**Optional:** Add a pipeline diagram (data flow: Dataset → IGTD → CNN → Grad-CAM) if you create one.

---

## LaTeX Figure Insertion

Add this block to your thesis (e.g., in Result Discussion chapter) after the "Figures to attach" list:
...
% Add similar blocks for gradcam_sample_3.png through gradcam_sample_8.png
```
...
**Repository:** https://github.com/mzaman2016/VitaScreen

**Branch:** DEV_Parva (create and push your Grad-CAM code here)

---

## Full Code

### 1. gradcam_explainability.py (Main XAI Script – After Grad-CAM)

```python
"""
Explainable AI: Grad-CAM for Diabetes CNN Predictions
Uses new dataset (cdcNormalDiabeticFE1_20RFFSQ.csv), IGTD, CNN, and Grad-CAM.
"""
...
### 2. diabetes_prediction_pipeline.py (Base Pipeline – Before Grad-CAM)

This is the original pipeline without Grad-CAM. Key components: load dataset, IGTD, ENN, CNN training, evaluation. The full file is in your project folder. Main difference: no Grad-CAM class, no heatmap visualization.

---

### 3. IGTD_Functions.py

Required for both pipelines. Contains: `min_max_transform`, `generate_feature_distance_ranking`, `generate_matrix_distance_ranking`, `table_to_image`, `generate_images_with_index`, `save_images_diabetic_naming`. Full file is in your project folder.
